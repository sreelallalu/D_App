...
public class ViewNotes extends BaseActivity {
    ...
    private void getDetails(StudentModel.Datum user) {
        ...
        RestBuilderPro.getService().viewnotes(hashMap).enqueue(new Callback<ResponseBody>() {
            @Override
                        ...
                        if (succ == 1) {
                            ...
                            if (jsonArray.length() != 0) {
                                for (int i = 0; i < jsonArray.length(); i++) {
                                    ...
                                    String link = object.getString("no_data");
                                ...
                                ViewAdapter adapter = new ViewAdapter(viewlist, ViewNotes.this, 1);
